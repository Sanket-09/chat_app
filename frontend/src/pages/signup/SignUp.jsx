...
const SignUp = () => {
	...
	return (
		<div className='flex flex-col items-center justify-center min-w-96 mx-auto bg-sky-900 rounded-lg'>
			<div className='w-full p-6 rounded-lg shadow-md bg-black bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				...
				<form onSubmit={handleSubmit}>
					...
					<div>
						<button className='btn btn-block btn-sm mt-2 border border-white' disabled={loading}>
